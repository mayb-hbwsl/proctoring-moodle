...
$string['fixedquestions'] = 'Fixed number of questions';
$string['fixedquestions_help'] = 'Set a fixed number of questions for all attempts. When greater than 0, the quiz will always administer exactly this many questions, ignoring the standard error stopping criterion. Set to 0 to use the minimum/maximum questions and standard error instead.';
$string['fixedquestionsreached'] = 'Fixed number of questions reached';
...
$string['sebrequired'] = 'This quiz must be opened using Safe Exam Browser. Click the button below to launch it.';
$string['seblaunchbtn'] = 'Launch Safe Exam Browser';
$string['sebnotdetected'] = 'Safe Exam Browser is not detected. Please use the button below to open this quiz in Safe Exam Browser.';
$string['sebinvalidkey'] = 'Safe Exam Browser detected but the Browser Exam Key is invalid. Make sure you are using the correct SEB configuration for this quiz.';
...
$string['score'] = 'Score';
$string['attemptscore'] = 'Best score (scored/total %)';
$string['attemptlatestscore'] = 'Latest score (scored/total %)';
